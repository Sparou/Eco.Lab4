...
void Task4() {
	...
	g_pIVFB->pVTbl->WriteString(g_pIVFB, 0, 0, 36, write_row, CHARACTER_ATTRIBUTE_FORE_COLOR_GREEN, "COMPLETE_4", 10);
	++write_row;
}
...
*/
	...
	pIScheduler->pVTbl->NewTask(pIScheduler, Task1, times[0], 0x100, &pITask1);
	pIScheduler->pVTbl->NewTask(pIScheduler, Task2, times[1], 0x100, &pITask2);
	pIScheduler->pVTbl->NewTask(pIScheduler, Task3, times[2], 0x100, &pITask3);
	pIScheduler->pVTbl->NewTask(pIScheduler, Task4, times[3], 0x100, &pITask4);
    ...
    pIVFB->pVTbl->WriteString(pIVFB, 0, 0, 36, 1, CHARACTER_ATTRIBUTE_FORE_COLOR_YELLOW, "Eco.Lab4", 9);
    pIVFB->pVTbl->WriteString(pIVFB, 0, 0, 35, 2, CHARACTER_ATTRIBUTE_FORE_COLOR_YELLOW, "TASK1 - 8s", 10);
    pIVFB->pVTbl->WriteString(pIVFB, 0, 0, 35, 3, CHARACTER_ATTRIBUTE_FORE_COLOR_YELLOW, "TASK2 - 4s", 10);
    pIVFB->pVTbl->WriteString(pIVFB, 0, 0, 35, 4, CHARACTER_ATTRIBUTE_FORE_COLOR_YELLOW, "TASK3 - 5s", 10);
    pIVFB->pVTbl->WriteString(pIVFB, 0, 0, 35, 5, CHARACTER_ATTRIBUTE_FORE_COLOR_YELLOW, "TASK4 - 2s", 10);
